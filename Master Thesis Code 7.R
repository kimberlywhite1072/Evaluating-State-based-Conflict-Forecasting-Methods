...
### Objective: Plot prediction error for Models B1, B2, and B3 (GLM)
...
########## DATA PREPARATION FOR MODEL B1 / MODEL B2 ##########
...
########## CROSS VALIDATION GRAPH FOR MODELS B1, B2, B3 ##########
...
combined_graph <- ggplot() +
  ...
  labs(x = "Prediction Error", y = "Percentage of Correct Predictions", title = "Hierarchical Hurdle Model with GLM", color = "") +
  ...
  scale_color_manual(values = c("Model B1" = "steelblue", "Model B2" = "red", "Model B3" = "green")) +
  theme_minimal() +
  theme(axis.text.x = element_text(angle = 45, hjust = 1),
...
combined_graph <- ggplot() +
  ...
  geom_line(data = bin_counts_B2, aes(x = bin, y = bin_percentage, color = "Model B2"), size = 1) +
  geom_line(data = bin_counts_B3, aes(x = bin, y = bin_percentage, color = "Model B3"), size = 1) +
  labs(x = "Prediction Error", y = "Percentage of Correct Predictions", title = "Hierarchical Hurdle Model with GLM",
       color = "") +
  scale_x_continuous(breaks = seq(1, 50, by = 1), labels = paste0("±", abs(seq(1, 50, by = 1)))) +
  scale_y_continuous(breaks = seq(0, 1, by = 0.0025), labels = scales::percent(seq(0, 1, by = 0.0025))) +
  scale_color_manual(values = c("Model B1" = "steelblue", "Model B2" = "red", "Model B3" = "green")) +
...
htmlwidgets::saveWidget(interactive_graph, file = "Part B - Hierarchical Hurdle Model with GLM.html")
